...
from app.notify import notify_evaluation_server  # optional, still logs locally
...
def process_request(data):
    ...
    # Instead of calling an external evaluation server, log locally
